...
#COPY tensorflow-2.1.0-cp36-cp36m-linux_x86_64.whl tensorflow-2.1.0-cp36-cp36m-linux_x86_64.whl
#RUN pip uninstall tensorflow && pip install tensorflow-2.1.0-cp36-cp36m-linux_x86_64.whl
COPY . /app
WORKDIR /app
#ENTRYPOINT python
CMD bash
